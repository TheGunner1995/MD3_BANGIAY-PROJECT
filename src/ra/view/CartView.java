...
import ra.controller.cart.ControllerCart;
...
public class CartView {
    private static ControllerCart controllerCart = new ControllerCart();
    private static ProductController productController = new ProductController();
    User userLogin = new UserView().getUserLogin();

    public void showCart() {
        if (controllerCart.getListCart().size()!=0){
            float total = 0;
            for (CartItem cartItem : controllerCart.getListCart()) {
    ...
    public void addToCart() {
        if (userLogin.getPhone()!=null&&userLogin.getAddress()!=null){
            ...
            if (product != null) {
                ...
                controllerCart.addToCart(new CartItem(product, quantity));
    ...
    public void updateCart() {
        ...
        controllerCart.updateCart(cartItem);
        showCart();
    }
    public void deleteAllCart(){
        controllerCart.deleteAllCart();
    }
}
